...
//     DeployContext private testCommon;
...
//             try actualStruct.scvUSD.processRewards() {
//             }
//             catch{
//             }
...
//             assertEq(actualStruct.cvxRewardToken.balanceOf(address(actualStruct.gUSD)) + actualStruct.llamaVault.balanceOf(address(actualStruct.gUSD)), actualStruct.scvUSD.getStreamableShares());
