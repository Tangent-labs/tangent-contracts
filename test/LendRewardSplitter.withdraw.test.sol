...
contract LendRewardSplitterWithdrawTest is Test {
    ...
    // function contextDeposit(
    //     uint amount,
    //     bool isStableReward,
    //     bool doDeposit,
    //     address tokenIn
    // ) internal {
    //     LendRewardSplitter.TOKEN_TYPE typeAsset = LendRewardSplitter
    //         .TOKEN_TYPE
    //         .LendAsset;
    ...
    // function contextWidthraw(
    //     uint depositAmount,
    //     bool isStableReward,
    //     LendRewardSplitter.TOKEN_TYPE tokenOutType
    // ) internal {
    ...
    //     contextDeposit(100 ether, true, true, tokenIn);
    //     assertEq(svcUSD.balanceOf(user), 100 ether);
    //     assertEq(splitter.stableDepositTotal(), 100 ether);
    //     vm.stopPrank();
    // }
    ...
    //     address tokenIn = TOKEN_crvUSD;
    //     address user = _getUser(1, tokenIn);
    //     contextDeposit(100 ether, true, false, tokenIn);
    //     assertEq(svcUSD.balanceOf(user), 100 ether);
    //     assertEq(splitter.stableDepositTotal(), 100 ether);
    //     vm.stopPrank();
    // }
    ...
    //     address tokenIn = TOKEN_crvUSD;
    //     address user = _getUser(1, tokenIn);
    //     contextDeposit(100 ether, false, true, tokenIn);
    //     assertEq(gUsd.balanceOf(user), 100 ether);
    //     assertEq(splitter.govDepositTotal(), 100 ether);
    //     vm.stopPrank();
    // }
    // function test_deposit_lendasset_with_gov_reward_deposit_disabled()
    //     external
    // {
    //     address tokenIn = TOKEN_crvUSD;
    //     address user = _getUser(1, tokenIn);
    //     contextDeposit(100 ether, false, false, tokenIn);
    //     assertEq(gUsd.balanceOf(user), 100 ether);
    //     assertEq(splitter.govDepositTotal(), 100 ether);
    //     vm.stopPrank();
    // }
    ...
    //     vm.stopPrank();
    // }
    // function test_deposit_lendcurveasset_with_gov_reward_deposit_enabled()
    //     external
    // {
    //     address tokenIn = CURVE_CRV_VAULT;
    //     address user = _getUser(1, tokenIn);
    ...
    //     vm.stopPrank();
    // }
    // function test_deposit_lendcurveasset_with_gov_reward_deposit_disabled()
    //     external
    // {
    //     address tokenIn = CURVE_CRV_VAULT;
    //     address user = _getUser(1, tokenIn);
    ...
    //     vm.stopPrank();
    // }
    // function test_deposit_lendstakeasset_with_gov_reward_deposit_enabled()
    //     external
    // {
    //     address tokenIn = STAKEDAO_CRV_VAULT;
    //     address user = _getUser(1, tokenIn);
    ...
    //     vm.stopPrank();
    // }
    // function test_deposit_lendstakeasset_with_gov_reward_deposit_disabled()
    //     external
    // {
    //     address tokenIn = STAKEDAO_CRV_VAULT;
    //     address user = _getUser(1, tokenIn);
    ...
    // function test_withdraw_all_lendcurveasset_from_svcUSD() external {}
    // function test_withdraw_all_lendasset_from_gusd() external {}
    // function test_withdraw_all_lendasset_from_svcUSD() external {}
    // function test_withdraw_half_lendcurveasset_from_gusd() external {}
    // function test_withdraw_half_lendcurveasset_from_svcUSD() external {}
    // function test_withdraw_half_lendasset_from_gusd() external {}
    // function test_withdraw_half_lendasset_from_svcUSD() external {}
    // function test_withdraw_lendstakedaoasset_from_svcUSD() external {}
    // function test_withdraw_not_existing_type_from_svcUSD() external {}
    // function test_withdraw_100_lendasset_from_svcUSD() external {}
    // function test_withdraw_100_lendasset_from_gusd() external {}
    // function test_withdraw_10000_lendasset_from_gusd_when_all_supply_is_borrowed()
    //     external
    // {}
    ...
    //     assertEq(gUsd.balanceOf(user), 0);
    //     assertEq(
    //         balancecrvUsdAfter - balancecrvUsdbefore,
    //         curvelendVault.convertToAssets(depositAmount)
    //     );
    //     vm.stopPrank();
    // }
}
