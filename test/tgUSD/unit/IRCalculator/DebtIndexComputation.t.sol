...
contract DebtIndexComputation is ConvexCurveContext {
    ...
    function test_fuzzing_with_big_bounds(uint256 oldIndex_, uint256 ir_, uint256 timeDelta_) external {
        oldIndex_ = bound(oldIndex_, 1e18, 10 * 1e18);
        ...
        uint256 calculated = irCalculator.newIndex(oldIndex_, ir_, timeDelta_);
