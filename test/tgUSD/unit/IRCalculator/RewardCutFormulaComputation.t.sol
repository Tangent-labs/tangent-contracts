...
contract RewardCutFormulaComputation is ConvexCurveContext {
    ...
    function test_rewardCut_step_greater_than_3_in_a_step() external view {
        uint256 rcCalculated = rewardAccumulator.simulateRC(
            994000000000000000,
            RCParams(0, uint16(5), uint32(50_000), uint32(100_000), uint80(996000000000000000), uint80(991000000000000000))
        );
    ...
    function test_rewardCut_price_under_endCutPrice() external view {
        uint256 rcCalculated = rewardAccumulator.simulateRC(
            994000000000000000,
            RCParams(0, uint16(5), uint32(50_000), uint32(100_000), uint80(998000000000000000), uint80(995000000000000000))
        );
    ...
    function test_rewardCut_price_over_startCutPrice() external view {
        uint256 rcCalculated = rewardAccumulator.simulateRC(
            998000000000000000,
            RCParams(0, uint16(5), uint32(50_000), uint32(100_000), uint80(99800000000000000), uint80(995000000000000000))
        );
    ...
    function test_rewardCut_price_with_big_steps() external view {
        uint256 rcCalculated = rewardAccumulator.simulateRC(
            993500000000000000,
            RCParams(0, uint16(100), uint32(50_000), uint32(100_000), uint80(996000000000000000), uint80(991000000000000000))
        );
    ...
    function test_rewardCut_with_one_step() external view {
        uint256 rcCalculated = rewardAccumulator.simulateRC(
            993500000000000000,
            RCParams(0, uint16(1), uint32(12_000), uint32(100_000), uint80(996000000000000000), uint80(991000000000000000))
        );
    ...
    function test_rewardCut_with_two_steps() external view {
        uint256 rcCalculated = rewardAccumulator.simulateRC(
            996000000000000000,
            RCParams(0, uint16(2), uint32(12_000), uint32(50_000), uint80(996000000000000000), uint80(991000000000000000))
        );
        assertEq(rcCalculated, 12_000);

        rcCalculated = rewardAccumulator.simulateRC(
            995000000000000000,
            RCParams(0, uint16(2), uint32(12_000), uint32(50_000), uint80(996000000000000000), uint80(991000000000000000))
        );
        assertEq(rcCalculated, 50_000);
