...
contract GetLPPriceCurveStableSwap is TgUSDDeployContext {
    ...
    function test_price_crvUSD_USDC(uint256 amountInSwap, uint256 amount0Lp, uint256 amount1Lp) external {
        ...
        IAggregatorV3 _coin0Oracle = IAggregatorV3(AddrChainlinkOracle.USDC);
        IAggregatorV3 _coin1Oracle = IAggregatorV3(AddrChainlinkOracle.CRVUSD);
        CurveStableLPOracle curveLPOracle = new CurveStableLPOracle(lp, _coin0Oracle, _coin1Oracle);
