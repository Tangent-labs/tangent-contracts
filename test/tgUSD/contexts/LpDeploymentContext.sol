...
contract LpDeploymentContext is StdCheats, StdUtils, Test {
    ...
    constructor(address creator, IERC20 _tgUSD) {
        tgUSD = _tgUSD;
        CreateTgUSDLpStruct[] memory params = new CreateTgUSDLpStruct[](2);
        params[0] = CreateTgUSDLpStruct({otherStable: AddrClassicERC20.TOKEN_USDC, name: "tgUSD-USDC", symbol: "tgUSDC", initialAmount: 5_000});
        params[1] = CreateTgUSDLpStruct({otherStable: AddrClassicERC20.TOKEN_USDT, name: "tgUSD-USDT", symbol: "tgUSDT", initialAmount: 5_000});
