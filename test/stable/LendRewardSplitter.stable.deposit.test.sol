...
contract LendRewardSplitterStableDepositTest is Test {
    ...
    function test_deposit_LendcurveassetWithStableRewardDepositDisabled() external {
        ...
        assertEq(testCommon.splitter().stableDepositTotal(), 0, "stableDepositTotal");
        ...
        assertEq(testCommon.splitter().stableDepositTotal(), depositAmount - incentive);
    ...
    function test_revertWhen_depositLendassetWithStableRewardDepositEnabledWithoutEnoughBalance() external {
        ...
        assertEq(testCommon.splitter().stableDepositTotal(), 0);
        vm.expectRevert();
        splitter.deposit(LendRewardSplitter.TOKEN_TYPE.LendAsset, depositAmount, true, true);
        vm.stopPrank();
    }
    function test_revertWhen_depositLendcurveassetWithStableRewardWithDepositWithoutEnoughBalance() external {
        ...
        assertEq(testCommon.splitter().stableDepositTotal(), 0);
        vm.expectRevert();
        splitter.deposit(LendRewardSplitter.TOKEN_TYPE.LendCurveAsset, depositAmount, true, true);
        vm.stopPrank();
    }
    function test_revertWhen_depositLendstakeassetWithStableRewardDepositEnabledWithoutEnoughBalance() external {
        ...
        assertEq(testCommon.splitter().stableDepositTotal(), 0);
        vm.expectRevert();
        splitter.deposit(LendRewardSplitter.TOKEN_TYPE.LendStakeDaoAsset, depositAmount, true, true);
        vm.stopPrank();
    }
    ...
    function test_revertWhen_depositWithNotExistingTokenTypeIn() external {
        ...
        splitter.deposit(LendRewardSplitter.TOKEN_TYPE(invalidEnumValue), depositAmount, true, true);
        vm.stopPrank();
    }
    function test_revertWhen_depositWithMoreThanMaxint() external {
        ...
        testCommon.getUser(1, testCommon.TOKEN_crvUSD());
        vm.expectRevert();
        splitter.deposit(LendRewardSplitter.TOKEN_TYPE.LendAsset, depositAmount + 1, true, true);
        vm.stopPrank();
    }
}
