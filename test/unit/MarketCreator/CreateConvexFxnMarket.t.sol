...
contract CreateConvexFxnMarket is MarketDeploymentContext {
    ...
    function setUp() external {
        ...
        rewardTokens[2] = AddrClassicERC20.FXN;
    ...
    function test_createConvexFxnMarket_success() external {
        vm.startPrank(owner);
        address market = marketCreator.createConvexFxnMarket(marketInit, PidCvxFxnBooster.USDC_fxUSD_LP, irParams, rcParams);
        ...
        assertTrue(address(ConvexFxnLPMarket(market).stakingProxyVault()) != address(0));
        ...
        assertEq(address(rewardAccumulator.rewardTokens(market, 2)), address(AddrClassicERC20.FXN));
    }
