...
import {QuotesPendlePT, PendlePTInQuoteParams, PendlePTOutQuoteParams, PendleSYToPTQuote, PendlePTToSYQuote} from "../../../src/chainview/USG/bot/QuotesPendlePT.cv.sol";

contract QuotePendlePT is MarketDeploymentContext {
    ...
    function test_quote_pendle_PT_to_USDC_with_sUSDe() public {
        ...
        CurveRouterSwapNoAmount memory routerDataIn = encoder.createCurveRouterNoAmountStruct(
            Array.memoryAddress(
                [
