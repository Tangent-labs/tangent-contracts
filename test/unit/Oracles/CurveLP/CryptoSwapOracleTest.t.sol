...
//             uint256 newApprox = approximateLPValue(pool);
//             skip(80000);
//             pool.price_oracle(0);
//             pool.price_oracle(1);
//             assertEq(oracleValueAfterSwap, oracles[pool].latestAnswer(), "After some time, oracle pricing should change");
//             assertApproxEqRel(newApprox, oracles[pool].latestAnswer(), 3e15, "After some time the price should have change");
//         }
//     }
