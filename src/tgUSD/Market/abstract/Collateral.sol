...
abstract contract Collateral is DebtIR, ICollateral {
    ...
    /// @notice Liquidation fee charged in tgUSD (e.g., 5% = 5,000)
    ...
    /**
     * @notice Returns the maximum amount of tgUSD a user can borrow based on their collateral
     * @param account Address of the user
     * @return Amount of tgUSD borrowable
     */
    ...
    /**
     * @dev Computes maximum borrowable tgUSD given a collateral amount
     * @param collatAmount Amount of collateral
     * @return Borrow limit in tgUSD
     */
    ...
    /**
     * @dev Internal view to calculate max borrowable tgUSD for a user
     * @param account Address of the user
