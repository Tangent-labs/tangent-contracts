...
interface ICurveTriCryptoSwap is IERC20Metadata {
    ...
    function add_liquidity(uint256[3] calldata amounts, uint256 min_mint_amount, bool use_eth, address receiver) external returns (uint256);
    function remove_liquidity(uint256 _amount, uint256[3] calldata min_amounts) external returns (uint256[3] calldata);
    function remove_liquidity(uint256 _amount, uint256[3] calldata min_amounts, bool use_eth) external returns (uint256[3] calldata);
    function remove_liquidity(uint256 _amount, uint256[3] calldata min_amounts, bool use_eth, address receiver) external returns (uint256[3] calldata);
    function remove_liquidity(uint256 _amount, uint256[3] calldata min_amounts, bool use_eth, address receiver, bool claim_admin_fees) external returns (uint256[3] calldata);
    ...
    function precisions() external view returns (uint256[3] calldata);
