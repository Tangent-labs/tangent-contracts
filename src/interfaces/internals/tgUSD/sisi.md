...
## Tokens linked to tgUSD

| Name          | Description                       | Type           |
| ------------- | --------------------------------- | -------------- |
| tgUSD         | Our stablecoin                    | Normal coin    |
| sgUSD         | Saving account of tgUSD           | Saving account |
...
| tgUSD-USDC    | Curve Stable pool                 | LP             |
| tgUSD-wCrvUSD | Curve Stable pool                 | LP             |
| tgUSD-wFrxUSD | Curve Stable pool                 | LP             |
| tgUSD-wUSDS   | Curve Stable pool                 | LP             |
| tgUSD-wDOLA   | Curve Stable pool                 | LP             |
| tgUSD-wUSR    | Curve Stable pool                 | LP             |

## Routing

| In                | Out     | Quote                                  | Approval                               | Swap                                                      |
| ----------------- | ------- | -------------------------------------- | -------------------------------------- | --------------------------------------------------------- |
| tgUSD             | sgUSD   | sgUSD.convertToShares(tgUSDAmount)     | tgUSD.approve(sgUSD,MAX_UINT)          | sgUSD.deposit(tgUSDAmount, walletAddress)                 |
| sgUSD             | tgUSD   | sgUSD.convertToAssets(sgUSDAmount)     | No need                                | sgUSD.redeem( sgUSDAmount, walletAddress, walletAddress ) |
