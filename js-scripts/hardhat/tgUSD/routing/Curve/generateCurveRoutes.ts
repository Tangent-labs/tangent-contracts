...
async function main() {
    ...
    if (!valid) {
        console.error("-------------------------");
        console.error(' ❌ Some strings are not associated to an address \n See "js-scripts/hardhat/tgUSD/contexts/CurveRouteGeneration:liquidationAssets" \n');
    ...
    console.log("✅ " + rawRoutes.length + " complete routes extracted from CSV : Check in ./js-scripts/tgUSD/routing/Curve/data/rawRoutes.json");
    ...
    console.log("✅ " + "Single swaps deduced and tested from the complete routes : Check in ./js-scripts/tgUSD/routing/Curve/data/singleSwaps.json");
    ...
    console.log("-------------------------");
    console.log("✅ Final routes written : Check in ./js-scripts/tgUSD/data/finalRoutes.json");
