...
import {BaseContext, StableLP} from "./BaseContext";
...
export class OracleContext {
    ...
    async deployAndSetupOracles(baseContext: BaseContext) {
        ...
        this.tgUSDOracle.connect(baseContext.owner).add_price_pair(baseContext.stableLp["tgUSD-USDC"]);
    }
}
