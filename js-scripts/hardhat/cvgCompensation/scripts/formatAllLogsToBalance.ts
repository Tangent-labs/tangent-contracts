...
import * as logsFile from "../logs/transfer-logs-StakeDao-CVG-FRAXBP.json";
...
async function main() {
    ...
    await fs.writeFile('./js-scripts/hardhat/cvgCompensation/snapshotitos/snapshot-StakeDao-CVG-FRAXBP-LP.json', JSON.stringify(finalResults, null, 2));
